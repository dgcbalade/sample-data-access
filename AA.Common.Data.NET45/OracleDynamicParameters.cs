...
namespace AA.Common
{   
    public partial class OracleDynamicParameters : Dapper.SqlMapper.IDynamicParameters 
    {
        ...
        private class ParamInfo
        {
            ...
            public System.Data.IDbDataParameter AttachedParam { get; set; }
        }
        ...
        public void Add(string name, object value = null, OracleDbType? dbType = null, System.Data.ParameterDirection? direction = null, int? size = null)
        {
            parameters[Clean(name)] = new ParamInfo() { Name = name, Value = value, ParameterDirection = direction ?? System.Data.ParameterDirection.Input, DbType = dbType, Size = size };
        }
        ...
        /// <param name="direction"></param>
        /// <param name="size"></param>
        public void Add(string name, object value, string dbType, System.Data.ParameterDirection? direction = null, int? size = null)
        {
            OracleDbType type;

            if (Enum.TryParse<OracleDbType>(dbType, true, out type))
                Add(name, value, type, direction, size);
            else
                throw new Exception("Impossible cast type to an valid type");
        }
